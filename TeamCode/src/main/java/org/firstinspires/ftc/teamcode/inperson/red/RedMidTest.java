...
@Autonomous(name = "Red Mid Test", group = "Red")
public class RedMidTest extends MatchOpMode {
...
// Drivetrain Hardware Initializations
    ...
    public void matchStart() {
        feeder.retractFeed();
        schedule(new RedMidGoalCommand(drivetrain, shooterWheels, feeder, intake, wobbleGoalArm, telemetry));
