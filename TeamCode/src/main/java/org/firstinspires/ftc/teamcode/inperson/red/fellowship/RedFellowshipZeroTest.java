...
@Autonomous(name = "RED Fellowship Zero Test", group = "RED")
public class RedFellowshipZeroTest extends MatchOpMode {
...
// Drivetrain Hardware Initializations
    ...
    public void matchStart() {
        feeder.retractFeed();
        schedule(new FellowshipRedZeroCommand(drivetrain, shooterWheels, feeder, intake, wobbleGoalArm, visionHG, telemetry));
