...
@Autonomous(name = "Blue Right One Test", group = "Blue")
@Disabled
public class BlueRightOneTest extends MatchOpMode {
...
// Drivetrain Hardware Initializations
    ...
    public void matchStart() {
        feeder.retractFeed();
        schedule(new RightBlueOneCommand(drivetrain, shooterWheels, feeder, intake, wobbleGoalArm, telemetry));
