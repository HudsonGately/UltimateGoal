...
import org.firstinspires.ftc.teamcode.inperson.red.inception.InceptionLeftRedZeroCommand;
...
@Autonomous(name = "RED Left Zero Test", group = "RED")
@Disabled
...
// Drivetrain Hardware Initializations
    ...
    public void matchStart() {
        feeder.retractFeed();
        schedule(new InceptionLeftRedZeroCommand(drivetrain, shooterWheels, feeder, intake, wobbleGoalArm, telemetry));
