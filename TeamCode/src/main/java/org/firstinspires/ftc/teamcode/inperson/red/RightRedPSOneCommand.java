...
public class RightRedPSOneCommand extends SequentialCommandGroup {
    public RightRedPSOneCommand(Drivetrain drivetrain, ShooterWheels shooterWheels, ShooterFeeder feeder, Intake intake, WobbleGoalArm wobbleGoalArm, Telemetry telemetry) {
        final int HG_SPEED = 3550;
        ...
        addCommands(
                ...
                new WaitCommand(300),
                new TurnToCommand(drivetrain, 207, telemetry),
                new FeedRingsCommand(feeder, 2),
                //Place Wobble Goal
