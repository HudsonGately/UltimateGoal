...
import org.firstinspires.ftc.teamcode.inperson.red.megaknytes.RightRedPSZeroCommand;
...
@Autonomous(name = "RED Right POWERSHOT Zero Test", group = "RED")
@Disabled
public class RedRightPSZeroTest extends MatchOpMode {
...
// Drivetrain Hardware Initializations
    ...
    public void matchStart() {
        feeder.retractFeed();
        schedule(new RightRedPSZeroCommand(drivetrain, shooterWheels, feeder, intake, wobbleGoalArm, telemetry));
