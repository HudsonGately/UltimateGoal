...
public class LeftRedOneCommand extends SequentialCommandGroup {
    ...
    public LeftRedOneCommand(Drivetrain drivetrain, ShooterWheels shooterWheels, ShooterFeeder feeder, Intake intake, WobbleGoalArm wobbleGoalArm, Telemetry telemetry) {
