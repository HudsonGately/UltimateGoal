...
@Disabled
@Autonomous(name = "RED Four Ring Test", group = "RED")
public class RedFourRingTest extends MatchOpMode {
...
// Drivetrain Hardware Initializations
    ...
    public void matchStart() {
        feeder.retractFeed();
        schedule(new RedFourHGCommand(drivetrain, shooterWheels, feeder, intake, wobbleGoalArm, telemetry));
