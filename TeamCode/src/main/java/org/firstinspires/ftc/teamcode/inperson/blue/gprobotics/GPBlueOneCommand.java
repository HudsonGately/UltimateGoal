...
public class GPBlueOneCommand extends SequentialCommandGroup {
    public GPBlueOneCommand(Drivetrain drivetrain, ShooterWheels shooterWheels, ShooterFeeder feeder, Intake intake, WobbleGoalArm wobbleGoalArm, Telemetry telemetry) {
