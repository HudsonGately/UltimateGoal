...
public class MegaknightsBlueZeroCommand extends SequentialCommandGroup {
    public MegaknightsBlueZeroCommand(Drivetrain drivetrain, ShooterWheels shooterWheels, ShooterFeeder feeder, Intake intake, WobbleGoalArm wobbleGoalArm, Telemetry telemetry) {
