...
public class FellowshipRedZeroCommand extends SequentialCommandGroup {
    public FellowshipRedZeroCommand(Drivetrain drivetrain, ShooterWheels shooterWheels, ShooterFeeder feeder, Intake intake, WobbleGoalArm wobbleGoalArm, VisionHG vision, Telemetry telemetry) {
