...
public class FellowshipRedFourCommand extends SequentialCommandGroup {
    public FellowshipRedFourCommand(Drivetrain drivetrain, ShooterWheels shooterWheels, ShooterFeeder feeder, Intake intake, WobbleGoalArm wobbleGoalArm, Telemetry telemetry) {
        ...
        addCommands(
                ...
                new SplineCommand(drivetrain, new Vector2d(59.5, -9), 0, true),
