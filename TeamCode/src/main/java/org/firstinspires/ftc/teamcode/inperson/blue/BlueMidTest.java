...
@Autonomous(name = "Blue Mid Test", group = "Blue")
public class BlueMidTest extends MatchOpMode {
...
// Drivetrain Hardware Initializations
    ...
    public void matchStart() {
        feeder.retractFeed();
        schedule(new BlueMidGoalCommand(drivetrain, shooterWheels, feeder, intake, wobbleGoalArm, telemetry));
